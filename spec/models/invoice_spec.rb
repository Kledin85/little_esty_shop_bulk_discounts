...
RSpec.describe Invoice, type: :model do
  ...
  describe "instance methods" do
    ...
    it "discounted_revenue" do
      ...
      @customer_1 = Customer.create!(first_name: 'Joey', last_name: 'Smith')
      @invoice_1 = Invoice.create!(customer_id: @customer_1.id, status: 2, created_at: "2012-03-27 14:54:09")
      @ii_1 = InvoiceItem.create!(invoice_id: @invoice_1.id, item_id: @item_1.id, quantity: 13, unit_price: 10, status: 2) #97.5
      @ii_11 = InvoiceItem.create!(invoice_id: @invoice_1.id, item_id: @item_8.id, quantity: 9, unit_price: 10, status: 1) #76.5
      ...
      expect(@invoice_1.discounted_revenue).to eq(46.0)
      expect(@invoice_1.revenue_with_discount).to eq(174)
    end
